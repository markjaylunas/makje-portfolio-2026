...
export default function ButtonLinkCTA({
	...
	return (
		<Link
			className={cn(
				buttonVariants(),
				"relative text-sm font-medium rounded-full h-12 p-1 ps-6 pe-14 group transition-all duration-500 hover:ps-14 hover:pe-6 w-fit overflow-hidden bg-linear-to-br from-primary/35 to-chart-2/35",
				className,
			)}
			onClick={onClick}
			{...props}
